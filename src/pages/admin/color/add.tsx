...
import { useCreateColorMutation, useColorQuery } from "../../../services/color";
...
const AddColorAdmin: React.FC = () => {
  ...
  const handleFormSubmit = async (values: any) => {
    try {
      ...
      await createColor(updatedValues); // Gửi dữ liệu lên máy chủ
  ...
  return (
    <>
      <h2 className="title-appoiment">Thêm màu sắc</h2>
      <Form
        form={form}
        name="validateOnly"
        layout="vertical"
